...
chart.plot([5, 3, 4, 7, 2], name="John", stack="male", labels='{point.y} fruits <br /> ({point.percentage:.0f}%)')
...
chart.plot([3, 0, 4, 4, 3], name="Janet", stack="female", labels="{point.y} out of {point.total}")
chart